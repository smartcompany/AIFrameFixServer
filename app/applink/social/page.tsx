...
export const metadata: Metadata = {
  title: "AI Video Frame Extract — Download",
  description: "Install AI Video Frame Extract from the App Store or Google Play.",
  robots: { index: false, follow: false },
  openGraph: {
    title: "AI Video Frame Extract",
    description: "Extract high-quality frames from your videos.",
